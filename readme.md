...
LX 指 Lite-X，相对于较大的 Legacy 分支而言采用 dex2jar 提取而非 ApkMixin Hook；相对于较小的 Lite 而言采用了官方的 MSF 组件和 OICQ 组件。

## Where to get?
加入 QQ 群 ~~1082439478~~ 806552762 ，入群看消息和公告
...
## Join us.
欢迎开发加入！ QMCE 正是~~缺 token 的时候~~ （划掉）需要人的时候
加群联系即可
